...
def _load_models():
    ...
    # Resolve model root: use DRIVE_ROOT env var if set (Colab),
    # otherwise resolve relative to this file's location (deployment server).
    ...
    _topic_model     = TopicModel.load(os.path.join(_model_root, "topic"))
