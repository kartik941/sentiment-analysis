...
export default function CsvUpload() {
  ...
  async function analyze() {
    ...
    try {
      ...
      const data  = await predictBatch(texts, platform);
      setResults(data.results);
      setSummary({ processed: data.processed, skipped: data.skipped });
    } catch (e) {
      setError("Batch analysis failed. Check backend console.");
      console.error(e);
    } finally {
      setProcessing(false);
    }
  ...
  function exportCsv() {
    ...
    a.href = url; a.download = "sentiment_results.csv"; a.click();
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr", gap: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              ...
              { label: "Output",        value: "Labelled + export CSV",     icon: "✓", color: C.pos    },
